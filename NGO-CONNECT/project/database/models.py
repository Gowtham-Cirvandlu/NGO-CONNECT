...
class User(UserMixin, db.Model):
    ...
    created_at = db.Column(db.DateTime, default=lambda: datetime.now(ZoneInfo("Asia/Kolkata")).replace(tzinfo=None), index=True)
...
class AdminAuditLog(db.Model):
    ...
    timestamp = db.Column(db.DateTime, default=lambda: datetime.now(ZoneInfo("Asia/Kolkata")).replace(tzinfo=None), index=True)
...
class AdminUserRole(db.Model):
    ...
    assigned_at = db.Column(db.DateTime, default=lambda: datetime.now(ZoneInfo("Asia/Kolkata")).replace(tzinfo=None), index=True)
